/* Generated By:JavaCC: Do not edit this line. P3TokenManager.java */

/** Token Manager. */
public class P3TokenManager implements P3Constants
{
...
/** Constructor. */
public P3TokenManager(SimpleCharStream stream){
...
/** Constructor. */
public P3TokenManager(SimpleCharStream stream, int lexState){
   this(stream);
   SwitchTo(lexState);
}
